    ...
    <div className="space-y-6 w-full mx-auto">
      ...
      {section.type === 'lab' && section.labConfig ? (
        ...
        <div className="bg-slate-900/90 rounded-2xl p-6 border border-emerald-500/30 shadow-xl space-y-6 text-slate-100">
          ...
          {section.type === 'interactive_demo' && (
            <div className="bg-slate-950 rounded-2xl p-6 text-white space-y-5 shadow-lg border border-slate-800">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 pt-2">
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs sm:text-sm font-semibold text-emerald-300 bg-slate-900 hover:bg-slate-800 border border-emerald-500/30 transition-colors cursor-pointer shadow-md"
        >
