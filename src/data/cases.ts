...
export const CASE_REGISTRY: CaseData[] = [
  {
    ...
    imageTexture: 'https://commons.wikimedia.org/wiki/Special:FilePath/Southern_burrowing_owl_(Athene_cunicularia_cunicularia)_Colonia.jpg?width=800',
    isUrgent: false,
  ...
  },
  {
    ...
    caseBudget: 600,
    minimumRank: 'Estagiário',
    imageTexture: 'https://commons.wikimedia.org/wiki/Special:FilePath/Red-footed_Tortoise_(Chelonoidis_carbonarius)_(34611375013).jpg?width=800',
    isUrgent: false,
  ...
  },
  {
    ...
    caseBudget: 1200,
    minimumRank: 'Estagiário',
    imageTexture: 'https://commons.wikimedia.org/wiki/Special:FilePath/Blue-and-yellow_Macaw_(Ara_ararauna).jpg?width=800',
    isUrgent: true,
  ...
  },
  {
    ...
    caseBudget: 950,
    minimumRank: 'Estagiário',
    imageTexture: 'https://commons.wikimedia.org/wiki/Special:FilePath/Eunectes_notaeus_(Puntaverde_Zoo,_Italy).jpg?width=800',
    isUrgent: false,
  ...
  },
  {
    ...
    imageTexture: 'https://commons.wikimedia.org/wiki/Special:FilePath/Harpy_Eagle_(Harpia_harpyja).jpg?width=800',
    isUrgent: true,
  ...
  },
  {
    ...
    caseBudget: 4000,
    minimumRank: 'Residente',
    imageTexture: 'https://commons.wikimedia.org/wiki/Special:FilePath/Jaguar,_Panthera_Onca.jpg?width=800',
    isUrgent: true,
  ...
  },
  {
    ...
    caseBudget: 3200,
    minimumRank: 'Residente',
    imageTexture: 'https://commons.wikimedia.org/wiki/Special:FilePath/Myrmecophaga_tridactyla.jpg?width=800',
    isUrgent: true,
  ...
  },
  {
    ...
    caseBudget: 1800,
    minimumRank: 'Residente',
    imageTexture: 'https://commons.wikimedia.org/wiki/Special:FilePath/Lobo-guará_(Chrysocyon_brachyurus).jpg?width=800',
    isUrgent: false,
  ...
  },
  {
    ...
    caseBudget: 1500,
    minimumRank: 'Residente',
    imageTexture: 'https://commons.wikimedia.org/wiki/Special:FilePath/Ramphastos_toco.jpg?width=800',
    isUrgent: false,
  ...
  },
  {
    ...
    caseBudget: 2200,
    minimumRank: 'Residente',
    imageTexture: 'https://commons.wikimedia.org/wiki/Special:FilePath/Bradypus_variegatus.jpg?width=800',
    isUrgent: true,
  ...
  },
  {
    ...
    imageTexture: 'https://commons.wikimedia.org/wiki/Special:FilePath/Caiman_yacare.jpg?width=800',
    isUrgent: true,
  ...
  },
  {
    ...
    caseBudget: 3100,
    minimumRank: 'Especialista',
    imageTexture: 'https://commons.wikimedia.org/wiki/Special:FilePath/Leopardus_pardalis.jpg?width=800',
    isUrgent: true,
  ...
  },
  {
    ...
    caseBudget: 1500,
    minimumRank: 'Especialista',
    imageTexture: 'https://commons.wikimedia.org/wiki/Special:FilePath/Capivara(Hydrochoerus_hydrochaeris).jpg?width=800',
    isUrgent: false,
  ...
  },
  {
    ...
    caseBudget: 3600,
    minimumRank: 'Especialista',
    imageTexture: 'https://commons.wikimedia.org/wiki/Special:FilePath/Sapajus_apella.jpg?width=800',
    isUrgent: true,
  ...
  },
  {
    ...
    caseBudget: 1400,
    minimumRank: 'Especialista',
    imageTexture: 'https://commons.wikimedia.org/wiki/Special:FilePath/Iguana_iguana.jpg?width=800',
    isUrgent: false,
  ...
  },
  {
    ...
    imageTexture: 'https://commons.wikimedia.org/wiki/Special:FilePath/Argentine_black_and_white_tegu_(Salvator_merianae)_male_Vicente_Lopez.jpg?width=800',
    isUrgent: true,
  ...
  },
  {
    ...
    caseBudget: 4500,
    minimumRank: 'Chefe de Clínica',
    imageTexture: 'https://commons.wikimedia.org/wiki/Special:FilePath/Cerdocyon_thous.jpg?width=800',
    isUrgent: true,
  ...
  },
  {
    ...
    caseBudget: 1800,
    minimumRank: 'Chefe de Clínica',
    imageTexture: 'https://commons.wikimedia.org/wiki/Special:FilePath/Boa_constrictor.jpg?width=800',
    isUrgent: false,
  ...
  },
  {
    ...
    caseBudget: 4200,
    minimumRank: 'Chefe de Clínica',
    imageTexture: 'https://commons.wikimedia.org/wiki/Special:FilePath/Callithrix_jacchus.jpg?width=800',
    isUrgent: true,
  ...
  },
  {
    ...
    caseBudget: 5500,
    minimumRank: 'Chefe de Clínica',
    imageTexture: 'https://commons.wikimedia.org/wiki/Special:FilePath/Tapirus_terrestris.jpg?width=800',
    isUrgent: true,
